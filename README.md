...
A curated list of Yao Agents, Assistants, and MCP Tools.
...
See [CONTRIBUTING.md](CONTRIBUTING.md) for guidelines on submitting your own agents.

## Resources

- [Agent Data Schema](AGENT.md) - Metadata structure for agents
- [Repository Plan](PLAN.md) - Development roadmap
- [Yao Agents Website](https://yaoagents.com) - Official website
- [Yao Documentation](https://yaoapps.com/docs) - Yao framework docs
